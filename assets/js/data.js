...
window.CV = (function () {
  ...
  var hero = {
    ...
    clips: [
      ...
      { src: "snorkel-pair", poster: "poster-snorkel-pair", max: 1440,
  ...
  var voyages = [
    {
      ...
      clip: "snorkel-pair", clipMax: 1440,
      plate: { img: "palm-beach",   stop: 4 },
      img: "palm-shore", alt: "The Himmafushi sandbank at low water",
    ...
    },
    {
      ...
      clip: "shark", clipMax: 1440,
      plate: { img: "snorkellers",  stop: 1 },
      img: "ray-sand", alt: "Reef fish over coral in the South Malé Atoll",
    ...
    },
    {
      ...
      clip: "wake", clipMax: 1080,
      plate: { img: "float-blue",   stop: 2 },
  ...
  var gallery = [
    ...
    { img: "palm-beach",    cat: "islands", cap: "Where the palms give out" },
    { img: "fins",          cat: "aboard",  cap: "Fins, and the whole afternoon" },
