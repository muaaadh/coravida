...
ui: {
  "An excursion, a day, and how many are coming. Nothing is charged and no date is held until we have written back.": "选一条航线、一个日子，告诉我们几位同行。在我们书面回复之前，不收取任何费用，也不锁定日期。",
  "for a party of {n}": "{n}人团价格",
  "package price": "套餐价",
  "Every excursion is a private charter of the whole vessel. If none of these fit, choose the closest and tell us below.": "每条航线都是整船私人包船。如果没有完全合适的，请选最接近的一条，并在下方告诉我们。",
  "Day": "日期",
  "When?": "哪一天？",
  "How many aboard?": "几位登船？",
  "The package price is for a party of {n}. For {g} guests we send a firm price with our reply, and it may cost more.": "套餐价格适用于{n}人团。{g}位客人的确切价格将随回复一并发出，可能会更高。",
  "optional": "选填",
  "You": "您",
  "Where do we write back?": "回复发到哪里？",
  "Anything else?": "还有其他需求？",
  "Add-ons, things we can arrange, and notes. All optional.": "附加服务、可代为安排的项目与备注。均为选填。",
  "Add-ons join the estimate. Anything on request is quoted separately and may cost more.": "附加服务计入估价。按需安排的项目另行报价，可能产生额外费用。",
  "To be quoted": "另行报价",
  "Your enquiry": "您的咨询",
  "Your preferred day is taken — please choose another above.": "您首选的日期已被占用——请在上方另选一天。",
  "The package price is for a party of {n}. For a different number we send a firm price with our reply, and it may cost more. Priced add-ons are already counted; anything on request is quoted separately. We confirm the final figure in writing before a date is held.": "套餐价格适用于{n}人团。人数不同时，确切价格将随回复一并发出，可能会更高。含价附加服务已计入；按需安排的项目另行报价。锁定日期前，我们会以书面形式确认最终金额。",
  "Sending this holds nothing and charges nothing. We check the day, price your party and reply in writing; the date is held once you confirm.": "发送咨询不会锁定日期，也不收取费用。我们会核对日期、为您的团队报价并书面回复；您确认后才锁定日期。",
