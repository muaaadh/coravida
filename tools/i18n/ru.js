...
content: {
  ...
  addons: [
    { t: "Личный повар на борту", d: "Три блюда, приготовленные на ходу." },
    { t: "Фотограф", d: "Полдня на борту, обработанные файлы в течение недели." },
    { t: "Плавучий завтрак", d: "Подаётся на мелководье, на якоре." },
    { t: "Сервировка на косе", d: "Стол, зонт и маты, перенесённые на берег." },
    { t: "Дайвинг", d: "Два баллона, грузы и гид, на человека." },
    { t: "Трансферы из аэропорта и отелей", d: "Велана или ваш отель, в одну сторону." }
  ],
  vessel: {
    ...
    decks: [
      { t: "Флайбридж", d: "Верхний пост управления, солнечные маты и затенённый лаунж — лучшее место на переходе.",
        alt: "Флайбридж Tiffany Blanc 14 с воздуха, гости на борту" },
      { t: "Салон", d: "Кондиционер, панорамное остекление с обеих сторон и стол на шестерых.",
        alt: "Салон Tiffany Blanc 14 с кондиционером, вид вперёд к посту управления" },
      { t: "Кокпит и платформа", d: "Затенённая кормовая палуба, трап и купальная платформа у самой воды.",
        alt: "Гости поднимаются на Tiffany Blanc 14 из воды с кормы" },
      { t: "Вода", d: "Маты, круги и снаряжение уходят за борт, как только якорь встал.",
